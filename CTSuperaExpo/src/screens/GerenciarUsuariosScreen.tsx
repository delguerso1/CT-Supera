            ...
            >
              ...
              {activeTab === 'alunos' && (
                <>
                  ...
                  <Text style={styles.fieldLabel}>Dia de vencimento (1 a 31)</Text>
                  <TextInput
                    style={styles.input}
                    placeholder="Ex.: 5"
                    placeholderTextColor={colors.textMuted}
          ...
          <View style={styles.modalContent}>
            ...
            >
              ...
              <TextInput
                ...
                onChangeText={(value) =>
                  setMatriculaForm((prev) => ({ ...prev, dia_vencimento: value.replace(/\D/g, '').slice(0, 2) }))
                }
              />
              ...
              {matriculaForm.ja_aluno ? (
                ...
                <>
                  ...
                  <Text style={styles.matriculaHint}>
                    Dia do mês em que vence a primeira cobrança registrada no financeiro na matrícula.
                  </Text>
                  <TextInput
                    style={styles.input}
                    placeholder="Ex: 10"
